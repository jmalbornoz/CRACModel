...
%
% flow_s, pressure_s: system curve, dependent of ducting, grilles, louvers, etc. 
% flow, pressure: fan curve, obtained from measurements
% flow_e, e: efficiency curve
%
load fan

% performs fits for system curve: Q = Cs * sqrt(delta_p)
...
%flow = 0:1:24;
fan = P2(1)*flow.^2 + P2(2)*flow + P2(3);    % fan pressure loss
system = flow.^2/Cs^2;                       % system pressure loss
...
plot(flow,system)
hold on
plotyy(flow,fan,'g',flow,power,'r')
grid
